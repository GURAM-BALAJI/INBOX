...
if (isset($_POST['add'])) {
	...
	try {
		$stmt = $conn->prepare("INSERT INTO category (category_name,category_image) VALUES (:category_name,:category_image)");
		$stmt->execute(['category_name' => $category_name, 'category_image' => $filename]);
