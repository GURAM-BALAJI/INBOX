...
<body>
    ...
    <div class="login-box">
        ...
        <form action="verify.php" method="post">
            ...
            <input type="checkbox" name="keep_me"> <spam style="color:#03e9f4;">  Keep Me Login.</spam>
            <div class="user-box">
        ...
        ";
            ...
            <a style="float:right;">
                ...
                <span></span>
                <span></span>
                <input type="submit" name="login" value="SIGN IN" style="border:none;
                      background:none;
                      outline: none;
                      transition: .5s;
                      letter-spacing: 4px;
...
">
        ...
        <center>
            <a href="JoinUs" style="color:aquamarine;text-decoration: none;">
